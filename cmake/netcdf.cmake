...
if(WIN32)
  ...
  if(MSVC)
    cmake_path(SET NetCDF_C_IMPLIB ${NetCDF_ROOT}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}netcdf${CMAKE_STATIC_LIBRARY_SUFFIX})
    cmake_path(SET NetCDF_Fortran_IMPLIB ${NetCDF_ROOT}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}netcdff${CMAKE_STATIC_LIBRARY_SUFFIX})
  else()
...
-DCMAKE_PREFIX_PATH:PATH=${HDF5_ROOT}
